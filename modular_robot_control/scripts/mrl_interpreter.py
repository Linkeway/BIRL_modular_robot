...
def wait_for_robot(command_pos,actual_pos,num_joints):
    reached = False
    while not reached:
         reached = True
...
def mrl_interpretor():
    ...
    sub = rospy.Subscriber('joint_state', JointState, callback)
    ...
    while not rospy.is_shutdown():
        ...
        pub.publish(msg)
        wait_for_robot(msg.position,js.position,Num_Joints)
